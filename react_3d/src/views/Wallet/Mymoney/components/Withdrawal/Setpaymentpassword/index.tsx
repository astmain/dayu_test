...
function Setpaymentpasswordlqh({ onCustomEvent }: { onCustomEvent: () => void }) {
  ...
  // 倒计时方法startCountdown
  const { remainingTime, startCountdown } = useCountdown(60, "Setpaymentpassword")
  ...
  // 设置支付密码验证码Paymentpasswordcode

  // 模拟获取验证码的函数
  // 我的钱包--提现--设置支付密码--获取验证码检验手机验证
  const handleGetCaptchaPayment = async () => {
    try {
      ...
      // 这里可以调用后端接口获取验证码和调用倒计时方法startCountdown()
      // 调用获取验证码接口成功,调用倒计时方法
      ...
      <div className="flex justify-start flex-col">
        ...
        >
          ...
          <Form.Item label={null}>
            <div className="flex justify-center w-[770px] max-w-[770px] xl:w-[80vw] lg:w-[79vw] md:w-[92vw] sm:w-[91vw]">
