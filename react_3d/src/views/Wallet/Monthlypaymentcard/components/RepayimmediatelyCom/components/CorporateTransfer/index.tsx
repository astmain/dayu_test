...
function CorporateTransferLqh() {
  ...
  const onFinish = (values: any) => {
    ...
    console.log(params, "params把对公转账表单参数传给后端")
    // 调用接口代码传params
  ...
  // 关闭对公转账弹框和清空对公转账表单字段setIsModalOpenDg(false)
  ...
  return (
    <div className="w-[822px] bg-[#ffffff] h-[67.96vh] rounded-[20px] max-w-[822px] 2xl:w-[822px] xl:w-[62vw] lg:w-[67vw] md:w-[78vw] sm:w-[85vw]">
      <div className="text-center mt-[30px] text-[20px]">
        <span className="text-[#222222]">还款余额：</span>
        <span className="text-[#f05113]">￥3266.32</span>
      </div>

      <div className="pt-[30px] pb-[30px] pl-[110px] pr-[110px]">
        <div className="relative">
          ...
          >
            <Form.Item
              ...
              name="componeyname"
              className="leading-[56px] text-[18px] text-[#222222]"
              rules={[
                {
                  required: true,
                  message: "请输入公司名称",
            ...
            >
              <Space>
                <Form.Item noStyle>
                  <Input
                    className="w-[436px] h-[56px] text-[18px] max-w-[436px] 2xl:w-[436px] xl:w-[33vw] lg:w-[35vw] md:w-[44vw] sm:w-[40vw]"
                    placeholder="请输入公司名称"
                  />
                </Form.Item>
            ...
            <Form.Item
              label={<span className="text-[18px] text-[#222222]">还款单号</span>}
              className="leading-[56px] text-[18px] text-[#222222]"
              required
            >
              <Space>
            ...
            <Form.Item>
              <div className="mt-[-4px] h-[34px] font-normal text-[12px] text-[#f05113] pl-[87px] mb-[52px]">
                <p>说明：1、对公转账时请复制还款单号在备注里填写还款单号方便快速审核；</p>

                <p className="pl-[37px]">2、对公转账未备注还款单号审核将在24小时内完成。</p>
              </div>
...
export default CorporateTransferLqh
