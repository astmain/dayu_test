...
const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <div className="m-[20px_0] relative">
      ...
      {/* 每页条数选择 */}
      <div className="flex items-right absolute right-0 bottom-0" style={{ color: "#999999" }}>
        <select
          value={pageSize}
          onChange={(e) => onPageSizeChange(Number(e.target.value))}
          className="focus:outline-none cursor-pointer hover:bg-gray-100"
        >
