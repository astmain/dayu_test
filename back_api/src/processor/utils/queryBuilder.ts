...
export const joinQueryWithPage = (
  queryParams: IQueryParams,
): { queryParams: Record<string, any>; totalQueryParams: Record<string, any> } => {
...
export const executePagedQuery = async <T>(
  ...
  try {
    ...
    const { queryParams: prismaParams = {}, totalQueryParams = {} } = queryParams
      ? joinQueryWithPage(queryParams)
...
export const executePagedQuery2 = async <T>(
  model: any,
  queryParams: IQueryParams,
  keyMessage = '列表',
  keyName: string,
